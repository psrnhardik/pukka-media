        ...
        <div class="insideWrapper">
            ...
            <center class="coveredImage">
                <div style="z-index: 10;">
                    <img src="{{ asset('assets/images/logo.png') }}" alt="Pukka Media" style="height: 300px; width:auto; filter: invert(100%);margin-bottom: -3%;margin-top: 0; position: relative;" />
                    <h1>
                    ...
                    <div class="row mt-2" style="clear:both">
                        <div class="col-lg-12">
                            <div class="col-md-6">
                                <img src="{{ asset('assets/images/post1.jpg') }}" width="300px" height="300px" style="float: left;width: 33.33%;padding: 5px;display: table;" alt="">
                            </div>
                            <div class="col-md-6">
                                <img src="{{ asset('assets/images/post2.jpg') }}" width="300px" height="300px" style="float: left;width: 33.33%;padding: 5px;display: table;">
                            </div>
                            <div class="col-md-6">
                                <img src="{{ asset('assets/images/post1.jpg') }}" width="300px" height="300px" style="float: left;width: 33.33%;padding: 5px;display: table;">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- Footer -->
            <footer class="page-footer font-small blue text-white">
                ...
                <div class="footer-copyright text-center py-3">
                    <i class="fa fa-address-book"></i><p>+91 63566 10101</p><i class="fa fa-globe"></i><p>www.pukkamedia.com</p><i class="fa fa-envelope"></i><p>pukkamediaagency@gmail.com</p><p>All Rights Reserved by <a href="https://www.pukka.cypherocean.com" target="_blank">Pukka Media</a></p>
                </div>
                <!-- Copyright -->
